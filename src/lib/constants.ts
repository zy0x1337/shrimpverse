...
export const familyDescriptions: Record<string, string> = {
  ...
  Red:          "the classic beginner shrimp, endlessly variable",
  Orange:       "warm tones, same easy care as Red",
  Yellow:       "bright and cheerful, great in planted tanks",
  Green:        "rare in the hobby, surprisingly vivid",
  Blue:         "bold color, among the easiest to keep",
  Black:        "dramatic contrast, forgiving water parameters",
  Brown:        "earthy tones, often overlooked gems",
  White:        "clean and striking, pairs well with dark substrate",
  Crystal:      "soft acidic water, iconic red & white patterns",
  "Taiwan Bee": "collector favorites, intricate patterns, delicate",
  Tiger:        "bold stripes, closer to the wild form",
  Sulawesi:     "warm, mineral-rich, unlike any other shrimp",
  Amano:        "algae specialists, the workhorses of planted tanks",
